...
function buildRuntimePalette(scheme: ColorScheme): RuntimePalette {
  ...
  return {
    ...
    border: base.border,
    primaryLight: (base as any).primaryLight || base.primary,
    primaryDark: (base as any).primaryDark || base.primary,
    accent: (base as any).accent || base.primary,
    surfaceElevated: (base as any).surfaceElevated || base.surface,
  };
}
